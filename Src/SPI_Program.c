...
static SPI_Reg_t * SPIs[MAX_SPIs_NUMBER]={SPI1,SPI2,SPI3};
 ...
 * @retval			:	Error State
 */
ErrorState_t SPI_Transmit(const SPI_CONFIGS_t * SPI_Config, uint16_t * Data , uint8_t Buffer_Size)
{
	ErrorState_t 	Error_State = 	OK	;
	uint8_t 	  	Counter	  	=	0 	;
 ...
 * @retval			:	Error State
 */
ErrorState_t SPI_Transmit_IT(const SPI_CONFIGS_t * SPI_Config, uint8_t * Data , uint8_t Buffer_Size, void (* SPI_TXC_CallBackFunc)(void))
{
	ErrorState_t 	Error_State = 	OK	;
 ...
 * @retval			:	Error State
 */
ErrorState_t SPI_Enable_DMA_RX(SPI_SPI_NUMBER_t SPI_Num)
{
	ErrorState_t Error_State = OK;
 ...
 * @retval			:	Error State
 */
ErrorState_t SPI_Enable_DMA_TX(SPI_SPI_NUMBER_t SPI_Num)
{
	ErrorState_t Error_State = OK;
 ...
 */
ErrorState_t SPI_SET_Internal_Slave_State(SPI_SPI_NUMBER_t SPI_Num, SLAVE_STATE_t Slave_State)
{
	ErrorState_t Error_State = OK;
